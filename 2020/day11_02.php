...
function adjacentOccupiedSeats($rowNum, $seatNum, $seats)
{
  $adjacents = [];
  $minRow = 0;
  $maxRow = count($seats) - 1;

  $minSeat = 0;
  $maxSeat = count($seats[0]) - 1;
  ...
  return collect($adjacents)->count();
}
    ...
    foreach ($row as $seatNum => $seat) {
      switch (true) {
        ...
        case $seat === FLOOR:
          ...
          break;
        case $seat === OCCUPIED &&
          adjacentOccupiedSeats($rowNum, $seatNum, $seats) >= 5:
          $changedSeats[$rowNum][$seatNum] = FREE;
          break;
        default:
          $changedSeats[$rowNum][$seatNum] = $changedSeats[$rowNum][$seatNum];
          break;
      }
    }
  }
