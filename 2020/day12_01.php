...
function changeDirection($currentDirection, $rotation, $degrees)
{
  $orientations = [
    'N' => 0,
    'E' => 90,
  ...
  $currentDegrees = $orientations[$currentDirection];
  ...
  return array_search($newDegrees, $orientations);
}

function move($direction, $value, $position)
{
  switch ($direction) {
    case 'N':
